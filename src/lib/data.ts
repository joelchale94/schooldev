...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 11, 28, 8, 0),
    end: new Date(2025, 11, 28, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 11, 29, 9, 0),
    end: new Date(2025, 11, 29, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 11, 29, 10, 0),
    end: new Date(2025, 11, 29, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 11, 29, 11, 0),
    end: new Date(2025, 11, 29, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2026, 0, 1, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 0, 1, 10, 0),
    end: new Date(2026, 0, 1, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 0, 1, 11, 0),
    end: new Date(2026, 0, 1, 11, 45),
  },
